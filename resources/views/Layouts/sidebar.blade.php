         ...
         <ul class="list">
             <li>
                 ...
                 <div class="user-info m-b-20">
                     <div class="image">
                         <a href="{{ url('/profile') }}">
                             <img src="{{ asset('assets/images/ava.png') }}" alt="User">
                         </a>
                     </div>
                     <div class="detail">
                         <h6>{{ $user->name }}</h6>
             ...
             <li class="{{ Request::is('dashboard-klien*') ? 'active' : '' }}">
                 <a href="{{ url('/dashboard-klien') }}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a>
             </li>
             <li class="{{ Request::is('proposal') ? 'active' : '' }}">
                 <a href="{{ route('superadmin.proposal.index') }}"><i class="zmdi zmdi-folder-star-alt"></i><span>Data Proposal</span></a>
             </li>
             <li class="{{ Request::is('klien/proposal/create') ? 'active' : '' }}">
             ...
             <li class="{{ Request::is('dashboard-admin*') ? 'active' : '' }}">
                 <a href="{{ url('/dashboard-admin') }}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a>
             </li>
             <li class="{{ Request::is('proposal') ? 'active' : '' }}">
                 <a href="{{ route('superadmin.proposal.index') }}"><i class="zmdi zmdi-folder-star-alt"></i><span>Data Proposal</span></a>
             </li>
             ...
             {{-- MENU UNTUK ROLE INTERNAL LAINNYA --}}
             @elseif(Auth::check())
             <li class="{{ Request::is('dashboard-admin*') ? 'active' : '' }}">
                 <a href="{{ url('/dashboard-admin') }}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a>
             </li>
