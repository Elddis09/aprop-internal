            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="row align-items-center p-3">
                        <div class="col">
                            <h5 class="fw-bold mb-0">Proses Proposal</h5>
                        </div>
                        <p class="text-secondary">Silahkan mengubah status proposal sesuai dengan posisi saat ini.</p>
                    </div>
                    <div class="body ">
                        <form action="#" method="POST">
                            ...
                            <div class="form-group">
                                <label for="keterangan">Keterangan</label><input type="text" class="form-control" id="keterangan" name="keterangan"></label>
                            </div>
                            <div class="mb-3">
