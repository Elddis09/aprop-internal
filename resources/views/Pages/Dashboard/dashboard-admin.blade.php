...
<div class="d-flex">
    ...
    <main class="content flex-grow-1 p-3">
        <div class="container-fluid">
            ...
            @php
            $rolesWithoutGlobalStats = ['stafpimpinan', 'stafbinpres', 'sekretarisdua', 'ketuadua', 'keuangan', 'bai', 'stafumum', 'sekretaristiga', 'ketuatiga'];
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('superadmin.proposal.data-proposal') }}">
                        <div class="card text-center">
                            <div class="body">
